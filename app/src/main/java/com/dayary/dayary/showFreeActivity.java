...
public class showFreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                dialog = new ProgressDialog(showFreeActivity.this);
                    ...
                    public void onComplete(@NonNull Task<DataSnapshot> task) {
                        if (!task.isSuccessful()) {
                            ...
                            try {
                                ...
                                Toast.makeText(showFreeActivity.this, "작성한 일기기 없습니다!\n일기를 작성해주세요!", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
        ...
        if (requestCode == 1) {
            if (resultCode == 0) {
                if (todayDate.equals(lastDate)) {
                    ...
                    intent.putExtra("model", (Serializable) postModel);
                    Toast.makeText(showFreeActivity.this, "작성한 글이 있습니다!", Toast.LENGTH_SHORT).show();
                } else {
